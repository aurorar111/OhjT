...
public class Tietokanta {
    ...
    public static void lisaaVarausTietokantaan(String asiakasNimi, String asiakasGmail, String asiakasPuh, String asiakasSyntyma, String asiakasID) {
        ...
        String sql3 = "INSERT INTO mökit (hinta, mökkitaso, mökki_id, järjestelmä_id) VALUES (?,?,?,?)";
        //saatavuus
        try (Connection conn = connect();
            ...
            statement3.setString(3, String.valueOf(Kayttoliittyma.getMokkiID()));
            statement3.setString(4, String.valueOf(Kayttoliittyma.getJarjestelmaID()));
